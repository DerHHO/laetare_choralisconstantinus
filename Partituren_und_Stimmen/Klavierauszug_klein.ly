...
\header {
  ...
  qrcode = \klavierauszugkleinQRLaetareCConst
...
inhaltsMarkupLaetareCConst = \markup { }
...
#(include-special-characters)
  ...
  \bookOutputName "Klavierauszug_klein"
  \header {
...
\score {
  ...
  \new Staff <<
    \new Voice { 
      \optionalTranspose { 
        %\transpose c c \ablaufzeileIntroitusLaetareCConst 
      }
    }
    \new Voice = "vKlavierauszug_klein" {
      %{<Emergency_Section>%}
...
%{</Emergency_Section>%}
      ...
      \clef "treble"
      \optionalTranspose { 
        %\transpose c c \generic_instrumentIntroitusLaetareCConst 
      }
    }
...
\score {
  ...
  \new Staff <<
    \new Voice { 
      \optionalTranspose { 
        %\transpose c c \ablaufzeileTractusLaetareCConst 
      }
    }
    \new Voice = "vKlavierauszug_klein" {
      %{<Emergency_Section>%}
...
%{</Emergency_Section>%}
      ...
      \clef "treble"
      \optionalTranspose { 
        %\transpose c c \generic_instrumentTractusLaetareCConst 
      }
    }
...
\score {
  ...
  \new Staff <<
    \new Voice { 
      \optionalTranspose { 
        %\transpose c c \ablaufzeileCommunioLaetareCConst 
      }
    }
    \new Voice = "vKlavierauszug_klein" {
      %{<Emergency_Section>%}
...
%{</Emergency_Section>%}
      ...
      \clef "treble"
      \optionalTranspose { 
        %\transpose c c \generic_instrumentCommunioLaetareCConst 
      }
    }
